...
- Rotation controls: use fixed screen-space Tinkercad-style slots (top-left, top-right, and bottom-right) around the selected shape, keeping the curved-arrow glyphs upright instead of letting camera orbit move or rotate them around the model.
