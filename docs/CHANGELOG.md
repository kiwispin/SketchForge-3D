...
- Rotation controls: replaced the three identical flat rotate icons with camera-aware curved arrows projected onto the actual X, Y, and Z rotation planes, matching the protractor that appears during a drag.
